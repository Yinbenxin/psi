...
def _yacl():
    maybe(
        ...
        name = "yacl",
        urls = [
            "https://github.com/Yinbenxin/yacl/archive/refs/tags/gaia_0.1.1.tar.gz",
        ],
        strip_prefix = "yacl-gaia_0.1.1",
        sha256 = "e7709d5cd9397ffd7fce129c02acd80daa18b52ddd89ba923a6c9563c8080270",
    )
